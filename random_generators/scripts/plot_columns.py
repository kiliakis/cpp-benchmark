...
csv_files = [res_dir + 'cpp/fft/v5/fft-v5-fft.csv',
             res_dir + 'cpp/fft/v5/fft-v5-ifft.csv',
             res_dir + 'cpp/fft/v5/fft-v5-rfft.csv',
             res_dir + 'cpp/fft/v5/fft-v5-irfft.csv']

x_names = ['n_points'] * 4
y_names = ['Throughput'] * 4
err_name = 'Stdev'
line_names = ['fft', 'ifft', 'rfft', 'irfft']
image_name = images_dir+'cpp/fft/fft-v5.png'
x_label = 'Points'
y_label = 'Throughput [MB/s]'
title = 'FFTs Throughput v5'
